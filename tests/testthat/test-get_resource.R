...
test_that("errors properly", {
  # wrong type
  expect_error(get_resource(res_id = 123))
  # Invalid format (doesn't match regex)
  expect_error(get_resource("a794d603-95ab-4309-8c92-b48970478c1"),
               regexp = "The resource ID supplied \\('.+?'\\) is invalid"
  )
  # Correct format but not real
  expect_error(get_resource("00000000-0000-0000-0000-000000000000"),
...
test_that("returns full data if rows > 99999", {
  ...
  expect_message(data <- get_resource(
